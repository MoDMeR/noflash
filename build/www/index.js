...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"__esModule",{value:!0});var _store=require(37),_store2=_interopRequireDefault(_store),_xtend=require(43),_xtend2=_interopRequireDefault(_xtend),errTimeoutId=void 0;exports.default={namespace:"app",state:{title:"<em>No</em> Flash",tagline:"Track summoner spells",loading:!1,error:"",summoner:_store2.default.get("app:summoner")||"",region:_store2.default.get("app:region")||""},effects:{summoner:function(e,r,t,o){_store2.default.set("app:summoner",e),t("app:set",{summoner:e},o)},region:function(e,r,t,o){_store2.default.set("app:region",e),t("app:set",{region:e},o)},loading:function(e,r,t,o){t("app:set",{error:"",loading:!0},o)},error:function(e,r,t,o){t("app:set",{error:e.err.message,loading:!1},o),mixpanel.track("app:error",e.err),clearTimeout(errTimeoutId),errTimeoutId=setTimeout(function(){t("app:set",{error:"",loading:!1},o)},3e3)},clear:function(e,r,t,o){t("app:set",{error:"",loading:!1},o)}},reducers:{set:function(e,r){return(0,_xtend2.default)(r,e)}}};
